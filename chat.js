document.addEventListener('DOMContentLoaded', () => {
    ...
    modalConfirmBtn.addEventListener('click', () => {
        chatHistory = [];
        localStorage.removeItem('lindaChatHistory');
    ...
    function saveHistory() {
        localStorage.setItem('lindaChatHistory', JSON.stringify(chatHistory));
    }

    function loadHistory() {
        const savedHistory = localStorage.getItem('lindaChatHistory');
        chatWindow.innerHTML = '';
        if (savedHistory) {
